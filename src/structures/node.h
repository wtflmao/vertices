...
constexpr std::size_t MAX_DEPTH = 9;
...
public:
    ...
    std::array<std::unique_ptr<Node>, BVH_NODE_CHILDREN> children;
    std::size_t depth = 0;
    Node() noexcept;
    ...
    [[nodiscard]] const std::array<std::unique_ptr<Node>, BVH_NODE_CHILDREN>& getChildren() const noexcept;
