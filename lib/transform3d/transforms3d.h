...
public:
  ...
  */
 static Eigen::Matrix3d EulerAngle2Mat(double rx, double ry, double rz);
  ...
  * @return {Matrix3d} 返回3✖3的旋转矩阵.
  */
 static Eigen::Matrix3d EulerAngle2Mat(Eigen::Vector3d eular);
  ...
  */
 static Eigen::Quaterniond Euler2Quat(double rx, double ry, double rz);
  ...
  * @return {Vector3d} 欧拉角
  */
 static Eigen::Vector3d Mat2Euler(Eigen::Matrix3d mat);
  ...
  * @return {*}
  */
 static Eigen::Matrix3d Euler2Mat(double rx, double ry, double rz);
  ...
  * @return {Vector3d}  欧拉角
  */
 static Eigen::Vector3d Mat2EulerAngle(Eigen::Matrix3d mat);
  ...
  */
 static Eigen::Matrix3d Quat2Mat(Eigen::Quaterniond quat);
  ...
  */
 static Eigen::Vector3d Quat2Eular(Eigen::Quaterniond quat);
  ...
  * @return {Vector3d} 对应的欧拉角
  */
 static Eigen::Vector3d Quat2EularAngle(Eigen::Quaterniond quat);
  ...
  */
 static Eigen::Quaterniond Mat2Quat(Eigen::Matrix3d mat);
  ...
  * @return {*}
  */
 static Eigen::Matrix4d Compose(Eigen::Vector3d positon, Eigen::Vector3d rotEular);
  ...
  */
 static Eigen::Matrix4d Compose(Eigen::Vector3d positon, Eigen::Quaterniond quat);
  ...
  */
 static Eigen::Matrix4d ComposeEuler(double x, double y, double z, double rx,
                                     double ry, double rz);
  ...
  */
 static Eigen::VectorXd H2EulerAngle(Eigen::Matrix4d t);
  ...
  * @return Matrix3d
  */
 static Eigen::Matrix3d HDecompose(Eigen::Matrix4d t, Eigen::Matrix3d &rotate, Eigen::Vector3d &position);
...
public:
  ...
  */
 std::vector<Eigen::Vector3d> getTransWithPointCloud(const std::string &base,
  ...
  * @return {Matrix4d} 返回4✖4的齐次变换矩阵
  */
 Eigen::Matrix4d getTransForm(const std::string &start, const std::string &end);
